...
public class AlgorithmParserErrorListener extends BaseErrorListener {
	...
	@Override
	public final void syntaxError(final Recognizer<?, ?> recognizer, final Object offendingSymbol, final int line, final int position, final String message, final RecognitionException cause) throws ParseException {
